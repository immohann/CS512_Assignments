...
def gradient_descent(objective, derivative, random_WT, X_train, y_train, c,momentum, n_iter, step_size):
    ...
    for i in range(n_iter):
        ...
        # take a step
        random_WT = random_WT - new_change

        change = copy.deepcopy(new_change)
...
momentum = 0.3
model_name = "GD_1000_mom"
best, score = gradient_descent(crf_obj, crf_obj_gradient, random_WT, X_train, y_train, c,momentum, n_iter, step_size)
print('Done!')
